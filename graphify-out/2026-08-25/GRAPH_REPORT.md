...
## Corpus Check
- 84 files · ~18,595 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 357 nodes · 540 edges · 24 communities (19 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `076379a7`
...
- `HeaderFallback()` --calls--> `useBasketStore`  [EXTRACTED]
  components/HeaderFallback.tsx → store/store.ts
...
Cohesion: 0.15
Nodes (9): geistMono, geistSans, metadata, BottomBar(), tabs, DisableDraftMode(), Footer(), HeaderClerk() (+1 more)
...
Cohesion: 0.09
Nodes (22): CategoriesPage(), dynamic, revalidate, CategoryPage(), dynamic, revalidate, Orders(), dynamic (+14 more)
...
## Knowledge Gaps
- **140 isolated node(s):** `dynamic`, `revalidate`, `GroupedBasketItem`, `MiddlewareHandler`, `ButtonProps` (+135 more)
...
- **What connects `dynamic`, `revalidate`, `GroupedBasketItem` to the rest of the system?**
